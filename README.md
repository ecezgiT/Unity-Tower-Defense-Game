...
* **Wave System:** Dynamic spawner that manages difficulty progression and enemy pooling for performance.
* **Game Mechanics:** Interactive tower placement, health/resource management, and win/loss states.
* **UI/UX:** Integrated main menus using Unity's UI system.
